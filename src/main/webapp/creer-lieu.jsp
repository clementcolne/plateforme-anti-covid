...
<head>
	...
	<title>Covid Mechant - Creer un lieu</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-offset-2 col-sm-8 maincontent">
				...
				<br>
				<form action="/CreerLieuServlet" method="post">
					<div class="row">
						<div class="col-sm-6">
							<input name='name' class='form-control' type='text' placeholder='Nom du lieu' required>
						</div>
						<div class="col-sm-6">
							<input name='adress' class='form-control' type='text' placeholder='Adresse du lieu' required>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-sm-4 text-right">
							<input class="btn btn-action" type="submit" value="Valider la creation du lieu">
						</div>
					</div>
					</br>
				</form>
